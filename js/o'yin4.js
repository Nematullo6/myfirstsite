...
colorModeButtonDOM.addEventListener("click", () => {
  if (settings.mode === "dark") {
    ...
    settings.mode = "dark";
    colorModeButtonDOM.innerText = "Yorug' rejim";
  }
  draw();
});
...
function announceWinner() {
  if (settings.numberOfPlayers === 0) {
    winnerDOM.innerText = `Bot ${state.currentPlayer}`;
  } else if (settings.numberOfPlayers === 1 && state.currentPlayer === 1) {
    winnerDOM.innerText = `Sen`;
  } else if (settings.numberOfPlayers === 1 && state.currentPlayer === 2) {
    winnerDOM.innerText = `Bot`;
  } else {
    winnerDOM.innerText = `O'yinchi ${state.currentPlayer}`;
  }
  showCongratulations();
}
...
singlePlayerButtonDOM.forEach((button) =>
  button.addEventListener("click", () => {
    ...
    gameModeDOM.innerHTML = "O'yinchi vs. Bot";
    name1DOM.innerText = "O'yinchi";
    name2DOM.innerText = "Bot";
...
twoPlayersButtonDOM.forEach((button) =>
  button.addEventListener("click", () => {
    settings.numberOfPlayers = 2;
    gameModeDOM.innerHTML = "O'yinchi vs. O'yinchi";
    name1DOM.innerText = "O'yinchi 1";
    name2DOM.innerText = "O'yinchi 2";
...
autoPlayButtonDOM.forEach((button) =>
  button.addEventListener("click", () => {
    settings.numberOfPlayers = 0;
    name1DOM.innerText = "Bot 1";
    name2DOM.innerText = "Bot 2";
